...
<head>
    ...
    <title>Sign In — {{ config('app.name', 'BookFlow') }}</title>
...
<body class="bg-[#0f172a] text-slate-200 antialiased min-h-screen flex items-center justify-center">
    ...
    <div class="relative w-full max-w-md mx-4">
        ...
        <div class="text-center mb-8">
            ...
            <p class="text-slate-400 text-sm mt-1">Sign in to your BookFlow dashboard</p>
        </div>
        ...
        <div class="auth-card p-8">
            ...
            <form method="POST" action="{{ route('login') }}" class="space-y-5">
                ...
                <div class="flex items-center justify-between">
                    <label class="flex items-center gap-2 cursor-pointer">
                        <input type="checkbox" name="remember" class="w-4 h-4 rounded bg-slate-800 border-slate-600 text-amber-500 focus:ring-amber-500/30">
            ...
            <p class="text-center text-sm text-slate-400 mt-6">
                ...
                <a href="{{ route('register') }}" class="text-amber-400 hover:text-amber-300 font-medium transition">Create one</a>
            </p>
        </div>
    </div>
</body>
